...
namespace XInputWrapper
{
    public class XboxController
    {
        ...
        #region Polling
        //Starts polling the controllers
        ...
        //Stops Polling the controllers
        public static void StopPolling()
        {
            if (isRunning)
                keepRunning = false;
        }
        //Runs on a loop to get the state of each controller, and keep it updated. This runs on a separate thread.
